...
**Nível & Localização**
![Senior](https://img.shields.io/badge/-Pleno%2FSenior-black?style=flat)
![Remoto](https://img.shields.io/badge/-Remoto-purple?style=flat)
...
**Recomendação**
_"Iury é um desenvolvedor sênior excepcional que se destaca em múltiplas dimensões. Tecnicamente, possui profundo conhecimento em arquiteturas distribuídas e microsserviços, dominando com maestria as tecnologias que utiliza, especialmente JavaScript/TypeScript e Go. Sua capacidade de equilibrar atenção aos detalhes técnicos com compreensão do negócio é notável, sempre focado em entregar soluções escaláveis e de alto valor. É extremamente proativo e dedicado, destacando-se não apenas por sua excelência técnica, mas também por sua generosidade em compartilhar conhecimento e desenvolver seus pares. Sua liderança natural e didática o tornam uma referência para a equipe, sempre contribuindo com soluções inovadoras e otimizações constantes. Possui um perfil completo que combina alta performance técnica, entendimento de negócio e habilidades interpessoais excepcionais, fazendo dele um profissional verdadeiramente diferenciado e valioso para qualquer equipe."_
